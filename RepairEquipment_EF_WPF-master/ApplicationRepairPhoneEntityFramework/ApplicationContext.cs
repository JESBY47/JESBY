...
namespace ApplicationRepairPhoneEntityFramework
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Employee>().HasData(new Employee { ID_Employee = "JES", Password = "JES", 
                FIO = "Чиховский Михаил Русланович", ID_Position = 5, Series_Number_Password = "0000 000000", Address = "Воронеж", 
                Phone_Number = "89997220456", EmploymentDate = DateTime.Now });
